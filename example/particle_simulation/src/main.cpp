...
// const float PARTICLE_RADIOUS = 15.0f;
...
int main(int argc, char* argv[]) {
    ...
    while (window.isOpen()) {
        ...
        /* for (const auto& particle : particles) {
            ...
            circle.setPosition(particle.position.x - PARTICLE_RADIOUS, particle.position.y - PARTICLE_RADIOUS);
            window.draw(circle);
        } */
        ...
        for (const auto& constraint : constraints) {
            ...
            sf::Vertex line[] = { sf::Vertex { constraint.p1->position, sf::Color::White },
