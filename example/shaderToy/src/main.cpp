...
MyFrame::MyFrame(const wxString& title) : wxFrame(nullptr, wxID_ANY, title) {
    ...
    if (wxGLCanvas::IsDisplaySupported(vAttrs)) {
        ...
        wxSplitterWindow* textSplitter =
            new wxSplitterWindow(mainSplitter, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxSP_LIVE_UPDATE);
        ...
        logTextCtrl = new wxTextCtrl(logPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize,
...
void MyFrame::OnOpenGLInitialized(wxCommandEvent& event) { BuildShaderProgram(); }

void MyFrame::OnTextChange(wxStyledTextEvent& event) { BuildShaderProgram(); }
