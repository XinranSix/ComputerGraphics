...
rt_material SceneManager::create_material(glm::vec3 color, int specular, float reflect, float refract, glm::vec3 absorb,
                                          float diffuse, float kd, float ks) {
...
glm::vec3 SceneManager::get_color(float r, float g, float b) { return glm::vec3(r / 255, g / 255, b / 255); }
