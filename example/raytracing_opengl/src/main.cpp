...
namespace update {
    int jupiter = -1, saturn = -1, saturn_rings = -1, mars = -1, box = -1, torus = -1;
}
...
int main() {
    ...
    scene.spheres.push_back(
        SceneManager::create_sphere({ 2, 0, 6 }, 1, SceneManager::create_material({ 0, 0, 1 }, 50, 0.35)));
    // red sphere
    scene.spheres.push_back(
        SceneManager::create_sphere({ -1, 0, 6 }, 1, SceneManager::create_material({ 1, 0, 0 }, 100, 0.1), true));
    // transparent sphere
    scene.spheres.push_back(SceneManager::create_sphere(
        { 0.5, 2, 6 }, 1, SceneManager::create_material({ 1, 1, 1 }, 200, 0.1, 1.125, { 1, 0, 2 }, 1), true));

    // jupiter
    rt_sphere jupiter = SceneManager::create_sphere({}, 5000, SceneManager::create_material({}, 0, 0.0f));
    ...
    rt_sphere saturn = SceneManager::create_sphere({}, saturnRadius, SceneManager::create_material({}, 0, 0.0f));
    saturn.textureNum = 2;
    ...
    // mars
    rt_sphere mars = SceneManager::create_sphere({}, 500, SceneManager::create_material({}, 0, 0.0f));
    mars.textureNum = 3;
    ...
    // box
    rt_box box =
        SceneManager::create_box({ 8, 1, 6 }, { 1, 1, 1 }, SceneManager::create_material({ 0.8, 0.7, 0 }, 50, 0.0));
    box.textureNum = 5;
    ...
    std::vector<std::string> faces = {
        "./assets/textures/sb_nebula/GalaxyTex_PositiveX.jpg", "./assets/textures/sb_nebula/GalaxyTex_NegativeX.jpg",
        "./assets/textures/sb_nebula/GalaxyTex_PositiveY.jpg", "./assets/textures/sb_nebula/GalaxyTex_NegativeY.jpg",
        "./assets/textures/sb_nebula/GalaxyTex_PositiveZ.jpg", "./assets/textures/sb_nebula/GalaxyTex_NegativeZ.jpg"
    };
