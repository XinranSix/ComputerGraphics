...
public:
    ...
    static rt_material create_material(glm::vec3 color, int specular, float reflect, float refract = 0.0,
                                       glm::vec3 absorb = {}, float diffuse = 0.7, float kd = 0.8, float ks = 0.2);
    ...
    static rt_light_point create_light_point(glm::vec4 position, glm::vec3 color, float intensity,
                                             float linear_k = 0.22f, float quadratic_k = 0.2f);
